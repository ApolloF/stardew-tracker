...
const v = (id:string,name:string,emoji:string,season:Season,day:number,lovedGifts:string[],marriageCandidate=false):Villager => ({...m,id,name,emoji,iconPath:`/game-icons/villagers/${id}.png`,birthday:{season,day},lovedGifts,marriageCandidate,spoilerTier:id==='leo'?'late-game':'ordinary'});
