...
export const UI_ICON_KEYS=['home','today','tomorrow','bundles','crops','goals','collections','heart','calendar','fishing','perfection','reference','oracle','rain','sun','moon','clock','cart','tv','import','logout','search','warning','leaf','refresh','check','save','people','farmer','discoveries','skills','note','fire','egg','desert','flower','soup','nightMarket','pumpkin','ice','gift','fair','squid']as const;
