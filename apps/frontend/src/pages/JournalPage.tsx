...
import {
  BUNDLE_ROOMS, CROPS, FESTIVALS, FERTILIZERS, FISH, PROJECTS, QUEEN_OF_SAUCE, UI_ICON_KEYS, VILLAGERS,
...
const uiNames = new Set<UiIconName>(UI_ICON_KEYS as readonly UiIconName[]);
